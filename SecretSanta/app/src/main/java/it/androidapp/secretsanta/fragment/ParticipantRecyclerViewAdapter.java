...
import it.androidapp.secretsanta.fragment.ParticipantFragment.OnListFragmentInteractionListener;
...
public class ParticipantRecyclerViewAdapter extends RecyclerView.Adapter<ParticipantRecyclerViewAdapter.ViewHolder> {
    ...
    public ParticipantRecyclerViewAdapter(List<Participant> participantList, OnListFragmentInteractionListener listener) {
        mValues = participantList;
        mListener = listener;
    }
